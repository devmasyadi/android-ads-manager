...
class NativeAdLayout : RelativeLayout {
    private var mInflater: LayoutInflater
    private var mAdview: FrameLayout? = null
    ...
    private var mAdChoicesView: FrameLayout? = null
    private var mIconView: FrameLayout? = null
    private var mPriceTextView: TextView? = null
    private var mStoreTextView: TextView? = null
    private var mStarRating: TextView? = null
    private var mMediaView: FrameLayout? = null
    ...
    private fun init() {
        val v: View = mInflater.inflate(R.layout.nativead_layout, this, true)
        ...
        if (ad != null) {
            ...
            if (ad.images != null) {
                ...
                if (image.drawable != null) {
                    ...
                    TClient().executeImageGET(
                        context,
                        image.url,
                        0,
                        0,
                        object : ResponseImageHandler {
